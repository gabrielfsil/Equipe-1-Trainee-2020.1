      ...
      <div class="col d-flex justify-content-center">
        <form class="col-md-8" method="POST" action = '#'>
          <div class="form-group">
            ...
            <input type="text" value="Amendobobo de Oliveira Orninto" class="form-control" id="exampleFormControlInput1">
          </div>
          <div class="form-group">
              <label for="exampleFormControlInput1">E-mail</label>
              <input type="email" value="ornintolangorinco@mail.com" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
          ...
          <div class="form-inline">
            <div class="form-group d-flex justify-content-between my-1">
              <a class="d-flex justify-content-center mr-2" href="change-password.html"><button type="button" class="btn btn-warning">&#10094;Modificar Senha</button></a>
              <a class="d-flex justify-content-center mr-2" href="" data-toggle="modal" data-target="#exampleModal"><button type="submit" onclick="this.form.reset()" class="btn btn-primary">Atualizar Usuário</button></a>
            </div>
          </div>
          <div class="form-group d-flex justify-content-between my-1">
            <a class="d-flex justify-content-center" href="view-user.html"><button type="button" class="btn btn-primary">&#10094;Voltar</button></a>              
          </div>
        </form>
    ...
    <div class="modal-dialog  modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <img src="img/user.png" class="img-modal">
