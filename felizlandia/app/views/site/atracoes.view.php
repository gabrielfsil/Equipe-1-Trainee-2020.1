...
<!--CONTEÚDO PRINCIPAL-->
  ...
  <div class="atracoes">
    ...
    <div class="input-group d-flex justify-content-left mb-3">
      ...
      <input name="conteudo" value=
      "<?php if(isset($_GET['conteudo'])){echo $_GET['conteudo'];} ?>" type="text" class="form-control col-sm-6" aria-label="Input dropdown com botão dropdown segmentado" placeholder="Busque pelo nome da atração ou categoria">
