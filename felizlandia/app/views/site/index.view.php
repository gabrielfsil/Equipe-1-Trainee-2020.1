...
<body>
  ...
  <nav id="navbar" class="navbar navbar-expand-md navbar-dark fundofalso sticky" > <!-- bg-transparent-->
    ...
    <div class="mx-auto order-0">
      ...
      <span class="TogglerPaginaAtual">Home</span>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/gif.gif" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
              </div>
            </div>
            <div class="carousel-item">
              <img src="https://i.insider.com/538b9dbbecad049349850dcf?width=1100&format=jpeg&auto=webp" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
            <img src="https://media.npr.org/assets/img/2015/08/04/img_0944-a7b5c96343c5faf379d89ec358e7b1817a936aa0-s800-c85.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
