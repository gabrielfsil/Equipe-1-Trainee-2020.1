        ...
        <div class="col d-flex justify-content-center">
           <form class="col-md-8" method="POST" action = '#'><!--FORMULARIO-->
            ...
            <div class="form-group d-flex justify-content-between">
              ...
              <a class="d-flex justify-content-center" href="" class="w-50 mt-3 mb-0" data-toggle="modal" data-target="#exampleModal"><button type="submit" onclick="this.form.reset()" class="btn btn-primary">Criar Usuário</button></a>
            </div>
