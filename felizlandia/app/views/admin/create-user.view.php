        ...
        <div class="col d-flex justify-content-center">
           <form class="col-md-8" method="POST" action='/admin/user-store'><!--FORMULARIO-->
              <div class="form-group">
                  ...
                  <input name="userName" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Amendobobo de Oliveira">
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput1">E-mail</label>
                <input name="userEmail" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="fulanito@mail.com">
              ...
              <div class="form-group">
                ...
                <input name="userPassword" type="password" class="form-control" id="exampleInputPassword1" placeholder="Senha">
              </div>  
              <div class="form-group d-flex justify-content-between">
                <a class="d-flex justify-content-center" href="user-list"><button type="button" class="btn btn-primary">&#10094;Voltar</button></a>          
                <a class="d-flex justify-content-center" href="" class="w-50 mt-3 mb-0" data-toggle="modal" data-target="#exampleModal"><button type="submit" class="btn btn-primary">Criar Usuário</button></a>
              </div>
            </form>
